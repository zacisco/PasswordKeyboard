        ...
        if (primaryCode != 0) {
            ...
            switch (primaryCode) {
                case Keyboard.KEYCODE_DELETE:
                    ...
                    ic.sendKeyEvent(new KeyEvent(eventTime, eventTime, KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_DEL, 0, 0));
                    ic.sendKeyEvent(new KeyEvent(eventTime + 1, eventTime + 1, KeyEvent.ACTION_UP, KeyEvent.KEYCODE_DEL, 0, 0));
                    break;
