...
### Обновления:
v1.3.2
- Fix: Исправил удаление выделенного текста
- Оптимизация ресурсов и рефакторинг кода

v1.3.1
- Fix: Исправил символы на цифрах с шифтом. (Сделал символы не кодом,а текстом чтобы не ошибаться)
